...
const validarCampo = (expresion, input, campo) => {
    if (expresion.test(input.value)) {
        ...
        document.querySelector(`#grupo__${campo} img`).src = "./images/success-icon.svg";
        ...
        document.querySelector(`#grupo__${campo} img`).src = "./images/error-icon.svg";
...
const validarClave2 = () => {
    ...
    if (inputClave1.value !== inputClave2.value) {
        ...
        document.querySelector(`#grupo__Clave2 img`).src = "./images/error-icon.svg";
        ...
        document.querySelector(`#grupo__Clave2 img`).src = "./images/success-icon.svg";
